...
if __name__ == "__main__":
    train_path = '/co-detr/data/vehicle/train'
    val_path = '/co-detr/data/vehicle/val'
    test_path = '/co-detr/data/vehicle/test'
    json_train = '/co-detr/data/vehicle/train/train_annotations.coco.json'
    json_val = '/co-detr/data/vehicle/val/val_annotations.coco.json'
    json_test = '/co-detr/data/vehicle/test/test_annotations.coco.json'


    coco_annotation_path = '/co-detr/dataset/data/daytime/_annotations.coco.json'
    ...
    image_folder = '/co-detr/dataset/data/daytime/train'
